            ...
            <div class="page-container">
                ...
                @if(auth()->user()->is_admin)
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="m-l-15">
                                            <h2 class="m-b-0">{{$active_users}}</h2>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="m-l-15">
                                            <h2 class="m-b-0">{{$inactive_users}}</h2>
                                            <p class="m-b-0 text-muted">Pending Users</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="m-l-15">
                                            <h2 class="m-b-0">{{$pdffiles_count}}</h2>
                                            <p class="m-b-0 text-muted">PDF Files</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="m-l-15">
                                            <h2 class="m-b-0">{{$wordfiles_count}}</h2>
                                            <p class="m-b-0 text-muted">Word Files</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <img height="500px" style="margin-right: auto; margin-left: auto; display: block;"  src="assets/images/3634171.png" alt="">
                        </div>
                    </div>
