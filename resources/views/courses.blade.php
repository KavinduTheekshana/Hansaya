...
<section class="portfolio-section">
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-9 col-md-8" data-animscroll="fade-left">
						...
						<div class="event-inner-content">
							<div class="top-part">
								...
								<div class="content">
									...
									<h2 class="title"><a href="#">10 ශ්‍රේණිය :සෙනසුරාදා ප.ව 3:00 සිට 5:00 දක්වා (I කණ්ඩායම)</a></h2>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="event-inner-content">
							<div class="top-part">
								...
								<div class="content">
									...
									<h2 class="title"><a href="#">10 ශ්‍රේණිය :සිකුරාදා ප.ව 2:30 සිට 4:30 දක්වා (II කණ්ඩායම)</a></h2>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="event-inner-content">
							<div class="top-part">
								...
								<div class="content">
									...
									<h2 class="title"><a href="#">11 ශ්‍රේණිය :සඳුදා ප.ව 2:30 සිට 4:30 දක්වා (II කණ්ඩායම)</a></h2>
								</div>
							</div>
						</div>
					</div>
