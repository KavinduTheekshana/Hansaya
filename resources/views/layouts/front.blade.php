				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav mr-auto">
							<li class="drop-link">
								<a class="active" href="/">මුල් පිටුව</a>
                            </li>
...
<script src="js/studiare-plugins.min.js"></script>
	...
	<script
      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAcuvYDk04jY_H-o_EIcdr8vQi3Mz0eWnc&callback=initMap&libraries=&v=weekly"
      defer
	></script>
...
function initMap() {
  ...
  const uluru = { lat: 6.1476, lng: 80.7634 };
